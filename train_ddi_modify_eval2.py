...
from my_utils.preprocessors.ggnn_preprocessor import MyGGNNPreprocessor
from my_utils.preprocessors.drugfp_preprocessor import DrugFPPreprocessor
...
# from models.ggnn_dev_fuse import GGNN
...
#         ))
#
#         ggnn = GGNN(out_dim=fp_out_dim, hidden_dim=fp_hidden_dim, n_layers=conv_layers,
...
def set_up_predictor(method,
    ...
    if method == 'ggnn':
        ...
        encoder = GIN(out_dim=fp_out_dim, hidden_dim=fp_hidden_dim, n_layers=conv_layers,
                      dropout_ratio=0.0, concat_hidden=False)
    else:
...
def parse_arguments():
    ...
    method_list = ['nfp', 'ggnn', 'schnet', 'weavenet', 'rsgcn', 'ecfp', 'gin']
...
def main():
    ...
    # modify preprocessor
    # preprocessor = DrugFPPreprocessor()
