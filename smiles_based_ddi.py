...
from my_utils.parsers import CSVFileParserForPair
from setting import *
# 导入开发版本的GGNN
from models.ggnn_dev import GGNN
# from models.chin_ggnn import GGNN
from models.relgcn import RelGCN
...
def parse_arguments():
    ...
    parser.add_argument('--fp-batch-normalization', type=bool, default=False,
