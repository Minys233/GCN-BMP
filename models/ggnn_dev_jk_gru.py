...
class GGNN(chainer.Chain):
    ...
    def __init__(self, out_dim, hidden_dim=16,
                 ...
                 weight_tying=True, update_tying=True, self_loop=False,
                 ):
    ...
    def update(self, h, adj, step=0):
        ...
        out_h = self.update_layer(functions.relu(self.update_layers_0[update_layer_index](functions.concat((h, m), axis=1))))
