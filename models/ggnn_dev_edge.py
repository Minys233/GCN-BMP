#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 4/28/2019 3:41 PM
# @Author  : chinshin
# @FileName: ggnn_dev_edge.py
...
class GGNN(chainer.Chain):
    ...
    def __init__(self, out_dim, hidden_dim=16,
        ...
        with self.init_scope():
            ...
            self.message_self_loop_layers = chainer.ChainList(
    ...
    def update(self, h, adj, step=0):
        ...
        # self loop message
        # (minibatch, atom, hidden_dim)
        h_self = self.message_self_loop_layers[message_layer_index](h)
        m = m + h_self
